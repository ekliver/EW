...
public class AimarMovAlmacenDetTemp implements java.io.Serializable {
    ...
    private int impItemSol;
    private int valVtaDol;
    private int impItemDol;
    ...
    public int getImpItem() {
        return impItem;
    }

    public void setImpItem(int impItem) {
    ...
    public int getImpItemSol() {
        return impItemSol;
    }

    public void setImpItemSol(int impItemSol) {
    ...
    public int getImpItemDol() {
        return impItemDol;
    }

    public void setImpItemDol(int impItemDol) {
